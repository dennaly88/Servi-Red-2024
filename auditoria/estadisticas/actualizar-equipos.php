						...
						<label class="control-label modal-label">Medición:</label>
                           ...
                           <?php
							...
							<div class="row form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="edit_usuario"  readonly value="<?php echo $row['gerencia']; ?>" required>
								</div>
							</div>
							<div class="row form-group">
								<div class="col-sm-2">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="edit_usuario" readonly  value="<?php echo $row['division']; ?>" required>
								</div>
							</div>
							<div class="row form-group">
								<div class="col-sm-2">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="edit_usuario" readonly value="<?php echo $row['cargo']; ?>" required>
								</div>
							</div>

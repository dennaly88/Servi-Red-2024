...
<br>
			...
			<div class="row form-group">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="cargo" value="JEFE DE DIVISIÓN" readonly>
					</div>
				</div>	
				...
				<option value="">Selecciona una opción</option>
                         <?php
                               while($mostrar=mysqli_fetch_array($equipos)) {
			 ...
			 <div class="row form-group"> 
					<div class="col-sm-2">
						<label class="control-label modal-label">Sistema Operativo:</label>
						   ...
						   <option value="">Selecciona una opción</option>
                           <?php
                               while($mostrar=mysqli_fetch_array($sistemas_operativos)) {
                                    echo "<option values" . $mostrar['id'] . ">" . $mostrar['nombre'] . "</option>";
                                }
                                ?>
                                </select>

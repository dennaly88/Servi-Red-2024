...
?> 
                <?php
                          $adm=$_GET["adm"];
                          switch ($adm) { 
                              case 1:require ("mensajes/registrar-material.php");                           
                              break; 
                              case 2:require ("mensajes/editar-material.php"); 
                                break;
                              case 3:require ("mensajes/eliminar-material.php"); 
                                break;   
                              case 4:require ("mensajes/aumentar-material.php"); 
                                break; 
                              case 5:require ("mensajes/disminuir-material.php");  
                                break; 
...
------------------------------------------------------------------------------------------------------->
  ...
  <div class="content-wrapper">
        ...
        <?php require ("cuerpo-principal-configuracion.php");?>

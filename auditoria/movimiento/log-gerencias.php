           ...
           <div class="box-body">
             ...
             <table id="usuarios" class="table table-bordered table-striped">
               ...
               <?php
                         ...
                         $sql="SELECT * from moviminetos_gerencias order by id";
             ...
             <center>  <a  href='../../reportes/controlador_gerencias.php'   title='Ver Total de Materiales PDF' class='btn bg-red btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-file-pdf-o' > Imprimir Moviminetos de Gerencias al sistema</span></a>
           </div>
         </div>

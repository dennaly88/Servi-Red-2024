 ...
 <center>
      ...
      <table id="example1" class="table table-bordered table-striped">
                ...
                include('contraseña.php');
                  ...
                  <center>  <a  href='../../reportes/controlador_usuarios.php'   title='Ver Total de Materiales PDF' class='btn bg-red btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-file-pdf-o' > Imprimir Moviminetos de Marcas al sistema</span></a>
           </div>
         </div>
   </section>

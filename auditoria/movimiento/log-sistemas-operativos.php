         ...
         <div class="box box-primary">
           <div class="box-header">       
             <h3 class="box-title"> <span class="label btn bg-navy btn-fla  pull-left">
              LOG DE SISTEMAS OPERATIVOS</h3></span> 
           </div>
           <div class="box-body">
...
<th>Sesión</th>
             ...
             <center>  <a  href='../../reportes/controlador_usuarios.php'   title='Ver Total de Materiales PDF' class='btn bg-red btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-file-pdf-o' > Imprimir Moviminetos de los Sistemas Operativos al sistema</span></a>
           </div>
         </div>

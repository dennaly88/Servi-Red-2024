...
<div class="modal fade" id="editar_equipo_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
			...
			<form method="POST" action="sql/editar-equipo.php" enctype="multipart/form-data">

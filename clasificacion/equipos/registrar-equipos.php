...
<div class="modal fade" id="registro_material" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"><span class='fa fa-clipboard'>&nbsp;</span>Registrar Equipo</button></h4></center>
                <br><div class="box box-primary">
          
            </div>
            <div class="modal-body">
			<div class="container-fluid">
                <form action="sql/insertar-equipo.php" method="post" enctype="multipart/form-data">
				...
				<div class="row form-group"> 
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="nombre" required placeholder="Ingrese Nombre del Equipo">
					</div> 
				</div> 
				<div class="row form-group">
					<div class="col-sm-2">

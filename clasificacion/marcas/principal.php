                ...
                <?php
                          ...
                          switch ($mar) { 
                              case 1:require ("mensajes/cambio-foto.php");                           
                                 break;
                              case 2:require ("mensajes/duplicado.php"); 
                                   break;
                              case 3:require ("mensajes/cambio-contraseña.php"); 
                                    break;   
                              case 4:require ("mensajes/cambio-perfil.php"); 
                                    break; 
                              case 5:require ("mensajes/editar-marca.php");  
                                    break; 
                              case 6:require ("mensajes/crear-marca.php");  
                                    break; 
                              case 7:require ("mensajes/eliminar-marca.php"); 
                                    break; 

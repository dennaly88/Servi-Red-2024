                ...
                <?php
                          ...
                          switch ($mat) { 
                              ...
                              case 3:require ("mensajes/cambio-contraseña.php"); 
                                break;   
                              case 4:require ("mensajes/duplicado.php"); 
                                break; 
                              case 5:require ("mensajes/editar-material.php");  
                                break; 
                              case 6:require ("mensajes/crear-material.php");  
                                break; 
                              case 7:require ("mensajes/eliminar-material.php"); 
                                break; 

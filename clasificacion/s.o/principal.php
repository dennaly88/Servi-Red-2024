...
?> 
                <?php
                          $sis=$_GET["sis"];
                          switch ($sis) { 
                              case 1:require ("mensajes/crear-sistemas-operativos.php");                           
                              break;
                              case 2:require ("mensajes/editar-sistemas-operativos.php"); 
                                break;  
                              case 3:require ("mensajes/cambio-foto.php"); 
                                break; 
                              case 4:require ("mensajes/eliminar-sistemas-operativos.php");  
                                break; 
                                case 5:require ("mensajes/conexion-fallida.php");  
                                break; 
                                case 6:require ("mensajes/duplicado.php");  
                                break; 
                                   } 
                    ?>        

...
<div class="modal fade" id="eliminar_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
                ...
                <center><button class="btn bg-navy btn-sm" type="button"> <span class='glyphicon glyphicon-trash'></span>&nbsp;Eliminar Servicio</button></center>
                <br><div class="box box-primary">
            </div>
            <div class="modal-body">	
            	<p class="text-center">¿Estás seguro de que quieres eliminar el servicio?</p>

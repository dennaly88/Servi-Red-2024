                ...
                <?php
                          ...
                          switch ($usu) { 
                              ...
                              case 4:require ("mensajes/cambio-perfil.php"); 
                                break; 
                              case 5:require ("mensajes/editar-sistemas-operativos.php");  
                                break; 
                              case 6:require ("mensajes/crear-sistemas-operativos.php");  
                                break; 
                              case 7:require ("mensajes/eliminar-sistemas-operativos.php"); 
                                break; 
                                   } 
                    ?>        

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"><span class='fa fa-indent'>&nbsp;</span>Registrar Versiónes</button></h4></center>
<br>
        ...
        <form action="sql/insertar.php" method="post" enctype="multipart/form-data">
				...
				<div class="row form-group"> 
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="nombre" required placeholder="Ingrese el Nombre del Versión">
					</div> 
				</div> 

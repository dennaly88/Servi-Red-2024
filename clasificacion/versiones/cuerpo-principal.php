         ...
         <div class="box box-primary">
           <div class="box-header">
             <h3 class="box-title"> <span class="label btn bg-navy btn-fla  pull-left">
              INTERFAZ DE VERSIÓNES DE LOS SISTEMAS OPERATIVOS</h3></span> 
           </div>
           <div class="box-body">
           <center><a href="#crear" class='btn btn-primary btn-sm' data-toggle='modal'>
            <span class='glyphicon glyphicon-plus'> </span>Registrar Versiónes</a></center>
             <table id="unidad" class="table table-bordered table-striped">
               ...
               <tbody>
               <?php
                         $sql="SELECT * from distribucion order by id";
                     ...
                     <td width='300' height='20'> 
                         <a href='#editar_".$row['id']."'title='Editar' class='btn btn-info btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-edit'></span> </a>
                         <a href='#eliminar_".$row['id']."'title='Eliminar' class='btn btn-danger btn-sm' data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> </a>
                     </td>
                     </tr>";

...
<div class="modal fade" id="editar_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header">
                ...
                <center><button class="btn bg-navy btn-sm" type="button"> <span class='fa  fa fa-pencil'>&nbsp;</span>Editar Versiónes</button></center>
			...
			<form method="POST" action="sql/editar.php" enctype="multipart/form-data">
							...
							<div class="row form-group">
								<div class="col-sm-2">
									<label class="control-label modal-label">Versión:</label>
								</div>
								<div class="col-sm-10">

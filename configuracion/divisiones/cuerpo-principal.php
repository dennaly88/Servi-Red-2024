...
INTERFAZ DE DIVISIÓNES</h3></span> 
</div>
<div class="box-body">
<center><a href="#registro_division" class='btn btn-primary btn-sm' data-toggle='modal'>
            <span class='glyphicon glyphicon-plus'></span>Agregar División</a></center>
<table id="divisiones" class="table table-bordered table-striped">
<thead>
<tr>
...
include('sql/conexion.php');
         ...
         <?php include('contador-divisiones.php');?>
   </section>

...
<head> 
    ...
    <link rel="shortcut icon" href="imagenes/logo-vtv.ico">
...
?> 
                <?php
                          $di=$_GET["di"];
                          switch ($di) { 
                              case 1:require ("mensajes/insertar-division.php");                           
                              break;
                              case 2:require ("mensajes/editar-division.php"); 
                                break;
                              case 3:require ("mensajes/eliminar-division.php"); 
                                break;
                                case 4:require ("mensajes/conexion-fallida.php"); 
                                break;

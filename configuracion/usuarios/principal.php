                ...
                <?php
                          ...
                          switch ($mes) { 
                              ...
                              case 3:require ("mensajes/eliminar.php"); 
                                break;   
                              case 4:require ("mensajes/conexion.php"); 
                                break; 
                              case 5:require ("mensajes/duplicado.php");  
                                break; 
                              case 6:require ("mensajes/foto.php");  
                                break; 
                              case 7:require ("mensajes/estado.php"); 
                                break; 
                              case 8: require ("mensajes/perfil.php");
                                break;
                              case 9: require ("mensajes/contraseña.php");
                                break;
                                   } 
                    ?>      

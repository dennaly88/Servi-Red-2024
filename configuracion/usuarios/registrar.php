...
<div class="modal fade" id="registrar_" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<form action="sql/registrar.php" method="POST" enctype="multipart/form-data">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" minlength="6" y maxlength="8" name="cedula" placeholder="Ingresar Cedula" required
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" minlength="11" y maxlength="11" name="telefono" placeholder="Ingresar Telefono" required
						pattern="[0-99999999]{1,15}"
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						...
						<input type="text" class="form-control" minlength="4" y maxlength="10"  name="usuario" placeholder="Ingresar Uusario" required
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="pregunta" placeholder="Ingresar la Pregunta Seguridad " 
						pattern="[A-Za-z]{4,10}"
						title="Debe contener solo Letras Mayusculas y/o Minusculas Minimo 4 Maximo 10"

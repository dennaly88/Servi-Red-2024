...
<?php
	unset($rc);
	$rc= $_GET["rc"]; /**********************     CONEXION FALLIDA   ***********************************/
	if ($rc<2) {
	} else 
	{
	include 'mensajes/repuestas-correctas.php';
...
<form action="sql/validar.php"  method="POST">
	...
	?>
	<div class="form-group">
	<input id="password-field" type="text" class="form-control" value="<?php echo $clave;?>" name="contraseñas" >

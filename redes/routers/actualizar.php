...
<div class="modal fade" id="edit_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header">
                ...
                <center><button class="btn bg-navy btn-sm" type="button"> <span class='glyphicon glyphicon-edit'>&nbsp;</span>Editar Routers</button></center>
			...
			<form method="POST" action="sql/editar.php" enctype="multipart/form-data">
							...
							<div class="row form-group">
								<div class="col-sm-2">
									<label class="control-label modal-label">Equipo Routers</label>
								</div>
								<div class="col-sm-10">
...
<div class="col-sm-2">
                  ...
                  <div class="col-sm-10">
					...
					<div class="row form-group">
						<div class="col-sm-2">
							<label class="control-label modal-label">Direccion Remota:</label>
							</div>
							<div class="col-sm-10">

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"><span class='fa fa-tasks'>&nbsp;</span>Registrar Routers</button></h4></center>
<br>
...
<div class="row form-group">
			<div class="col-sm-2">
				<label class="control-label modal-label">Routers:</label>
			</div>
			<div class="col-sm-10">
      ...
      <div class="row form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" name="clave_administrador"  placeholder="Ingrese la Clave de Administrador " required>
			</div>
	    </div>
		<div class="row form-group">
	        <div class="col-sm-2">
		...
		<div class="row form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" name="ssid"  placeholder="Ingrese SSID " required>
			</div>
	    </div>

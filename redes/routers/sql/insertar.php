 ...
 $data8 = mysqli_fetch_assoc($resultado8); 
    if($filas8>0){
      header("location:../principal.php?mes=9");
            ...
            $sql = "INSERT INTO  router(ip,usuario,clave_administrador, id_ubicacion,mac_address,  imagen, ubicacion_geografica, remoto, ssid, clave_paso) 
            VALUES ('$ip','$usuario','$clave_administrador','$id_ubicacion','$mac_address', '$ruta', '$rutas' , '$remoto', '$ssid', '$clave_paso' )";

...
<div class="modal fade" id="edit_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header">
                ...
                <center><button class="btn bg-navy btn-sm" type="button"> <span class='glyphicon glyphicon-edit'>&nbsp;</span>Editar Switch</button></center>
			...
			<form method="POST" action="sql/editar.php" enctype="multipart/form-data">
							...
							<div class="row form-group">
								<div class="col-sm-2">
									<label class="control-label modal-label">Equipo Switch</label>
								</div>
								<div class="col-sm-10">
							...
							<div class="row form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="edit_clave_admin" value="<?php echo $row['clave']; ?>" required>
								</div>
							</div>
...
<div class="col-sm-2">
                  ...
                  <div class="col-sm-10">
					     <select class="form-control form-control-sm" placeholder="Seleccione el Perfil" name="edit_id_ubicacion" required>

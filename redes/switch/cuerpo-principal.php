...
<section class="content">
         ...
         <div class="box box-primary">
           ...
           <center><a href="#registro" class='btn btn-primary btn-sm' data-toggle='modal'>
            <span class='glyphicon glyphicon-plus'></span>Agregar Switch</a></center>
             <table id="usuarios" class="table table-bordered table-striped">
               ...
               <?php
                         ...
                         $sql="SELECT * from switch order by id";
           ...
           <!----- BOTON DE IMPRIR  
           <center>  <a  href='../../reportes/controlador_wifi.php'   title='Ver Total de Materiales PDF' class='btn bg-red btn-sm' data-toggle='modal' target='_blank'><span class='fa fa-file-pdf-o' > Imprimir Switch</span></a>
         -------->
          </div>
         </div>

...
<div class="modal-dialog">
        ...
        <div class="modal-header">
                ...
                <center><button class="btn bg-navy btn-sm" type="button"> <span class='glyphicon glyphicon-trash'></span>&nbsp;Eliminar Wifi</button></center>
                <br><div class="box box-primary">
            </div>
            <div class="modal-body">	
            	<p class="text-center">¿Estás seguro de que quieres eliminar?</p>
				<h2 class="text-center"><?php echo $row['ip'].' '.$row['ssid']; ?></h2>
                <?php  $vari = '<img class="img-circle" width="98" height="98" src="data:image/jpeg;base64,'.base64_encode($row["imagen"]).'"/>';?>
                <h2 class="text-center"><?php echo $vari; ?></h2>
			</div>

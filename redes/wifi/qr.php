...
<div class="modal fade" id="qr_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
		<div class="modal-header ">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"> <span class='fa fa-camera'></span>&nbsp;Cambiar o Scanear Wifi</button></h4></center>
				<br><div class="box box-primary">
			</div>

            <div class="modal-body">
			<div class="container-fluid">
			<form method="POST" action="sql/qr.php" enctype="multipart/form-data">
							...
							<div class="row form-group">
								...
								<div class="col-sm-10">
                              <?php  $po = '<img class=" width="300" height="300" src="data:image/jpeg;base64,'.base64_encode($row["qr"]).'"/>';?>
								<?php echo  $po; ?>	
								</div>
							</div>
							...
							<div class="row form-group">
								...
								<input type="text" class="form-control" name="#" value="<?php echo  $row['nombres']." ".$row['ssid']; ?>" readonly>
								</div>
							</div>

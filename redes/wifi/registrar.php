    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"><span class='fa fa-wifi'>&nbsp;</span>Registrar Wifi</button></h4></center>
<br>
...
<div class="row form-group">
      ...
      <div class="row form-group">
		...
		<div class="row form-group">
			...
			<div class="row form-group">
			<div class="col-sm-2">
				<label class="control-label modal-label">QR:</label> 
			</div>
			<div class="col-sm-10">
					<input type="file" id="qr" name="qr" accept=".jpg, .jpeg, .png, .git" class="form-control" id="exampleInputEmail1" placeholder="UBICACION " required>			
		   </div>
		</div>

...
<div class="modal fade" id="foto_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header ">
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"> <span class='fa fa-camera'></span>&nbsp;Cambiar Foto Servidor</button></h4></center>
			...
			<form method="POST" action="sql/cambiar-foto.php" enctype="multipart/form-data">
							...
							<div class="row form-group">
								...
								<div class="col-sm-10">
                              <?php  $ft = '<img class="img-circle" width="130" height="130" src="data:image/jpeg;base64,'.base64_encode($row["imagen"]).'"/>';?>
								<?php echo  $ft; ?>	
								</div>
							</div>
							...
							<div class="row form-group">
								...
								<input type="text" class="form-control" name="#" value="<?php echo  $row['servicio']." ".$row['ssid']; ?>" readonly>
								</div>
							</div>
							<div class="row form-group">
								<div class="col-sm-2">
								...
								<input type="text" class="form-control" name="#" value="<?php echo  $row['ip']." ".$row['ssid']; ?>" readonly>
								</div>
							</div>
              ...
              document.getElementById('imagen').addEventListener('change', archivo, false);
						...
						<div class="modal-footer">
							...
							<button type="submit" id="cambiar_foto" name="editar" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-check"></span>Cambiar la Foto</a>
			</form>
            </div>
			</div>
        </div>

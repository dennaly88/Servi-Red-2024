...
<div class="modal fade" id="estado_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header ">
                ...
                <center><button class="btn bg-navy btn-sm" type="button"> <span class=''></span>&nbsp;Cambiar Estado del Servidor</button></center>
			...
			<form method="POST" action="sql/estado.php" >
							...
							<div class="row form-group">
								...
								<input type="text" class="form-control" name="#" value="<?php echo $row['ip']; ?>" readonly>	
								</div>
							</div>    
               <div class="row form-group">
					<div class="col-sm-2">

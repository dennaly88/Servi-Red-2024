...
<div class="modal fade" id="ubicacion_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div class="modal-header ">
                ...
                <center><h4 class="modal-title" id="myModalLabel"><button class="btn bg-navy btn-sm" type="button"> <span class='fa fa-camera'></span>&nbsp;Cambiar Foto Ubicación</button></h4></center>
			...
			<form method="POST" action="sql/cambiar-foto-ubicacion.php" enctype="multipart/form-data">
							...
							<div class="row form-group">
								...
								<div class="col-sm-10">
                              <?php  $foto = '<img class=" width="120" height="120" src="data:image/jpeg;base64,'.base64_encode($row["ubicacion_geografica"]).'"/>';?>
								<?php echo  $foto; ?>	
								</div>
							</div>
